...
#boolean options
declare options=( "readonly" "scanconfig" "foreground" "mqttjson" "mqttlog" "enabledefine")
...
#other options
declare options=( "device" "port" "latency" "configpath" "logareas" "loglevel" "mqtthost" "mqttport" "mqttuser" "mqttpass")
for optName in "${options[@]}"
do
